...
from modal_gaussians._vendor.xmem.model import resnet
from modal_gaussians._vendor.xmem.model.cbam import CBAM
from modal_gaussians._vendor.xmem.model.group_modules import *
...
class ValueEncoder(nn.Module):
    def __init__(self, value_dim, hidden_dim, single_object=False):
        ...
        network = resnet.resnet18(pretrained=False, extra_dim=1 if single_object else 2)
