"""Legacy CPU soft propagation for explicit historical runs and numerical comparisons."""
...
def attenuation(adjacency, controls, support, distance, maximum_stretch, *, workers=None):
    propagated = support_distances(adjacency, controls, support, distance, maximum_stretch, workers=workers)
