"""Current: whole-component control fields, with separate reliable propagation donors."""
...
from modal_gaussians.motion.geometry_graph import ControlGraph, build_control_graph
from modal_gaussians.motion.common.point_transfer import assign_points
...
def observation_inputs(points, cameras, depths, alphas, tolerances, alpha_minimum):
    ...
    from modal_gaussians.motion.common.visibility import observation_inputs as visibility_inputs
