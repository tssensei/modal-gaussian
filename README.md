...
| Temporal coefficients | [`coordinates/`](src/modal_gaussians/coordinates/) | `preparation.py`, `direct.py`, `rgb.py`, `fitting.py`, `rendering.py` | fixed mode bank, design, direct/RGB coefficients |
| Result binding and video | [`results/`](src/modal_gaussians/results/) | `artifact.py`, `video.py` | result manifest, comparison MP4 |
...
| Bind/export | `result materialize`, `result export-video` |
...
computed automatically, and an MP4 is not a metric input.
